...
>
	...
	<table border="1">
		...
		<xsl:apply-templates select="Prüfung[contains(@Klasse, $selectedClass2) and contains(@Fach, $selectedSubject2) and contains(@Name, $selectedExam2) and contains(@Datum, $selectedDate2) and contains(SchülerIn/Name/text(), $selectedPupil2)]/SchülerIn[contains(Name, $selectedPupil2) and contains(Note, $selectedGrade2)]"/>		
	</table>
